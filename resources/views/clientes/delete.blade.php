...
<div class="container">
    ...
    <div class="col-md-6 offset-md-3">
            ...
            <input class="form-control" type="text" name="telefono" disabled value="{{ $cliente[0]->telefono }}"
                pattern="[0-9]{4}-[0-9]{4}">
                <p class=" m-3"> <strong>IMPORTANTE: </strong> Esta operación no se puede deshacer, si se eliminan el cliente, también se eliminarán todos los datos relacionados a este.</p>
